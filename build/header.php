...
if(liarch_get_theme_mod('page_navigator',true) == 'custom'){
    $custom_style_navigator = liarch_get_theme_mod('page_navigator_style', true);
}
$html_class = '';
$main_class = '';
if($custom_style_navigator == 'two'){
    $html_class = 'modern';
}  elseif($custom_style_navigator == 'three'){
    $html_class = 'beige';
}
$theme_dark = liarch_get_theme_mod('theme_dark', true);



if($theme_dark == 'enable'){
    $html_class .= ' tm_theme_dark';
}
if( !class_exists('TM_Helper_Core_Addons')){
    $main_class .= ' plugin-disable';
}
...
<html <?php language_attributes(); ?> class="<?php echo esc_attr($html_class, 'liarch');?>">
<head>
...
<?php
$parallax = liarch_get_theme_mod('parallax', true);
$theme_dark = liarch_get_theme_mod('theme_dark', true);
$technical_draw = liarch_get_theme_mod('technical_draw', true);

$main_class = '';

if($theme_dark == 'enable'){
    $main_class .= 'tm_theme_dark';
}
if($technical_draw == 'enable'){
    $main_class .= ' technical-drawing';
}


if(liarch_get_theme_mod('preloader_page_show') == 'true') {
    $main_class .= ' animsition';
}

if($custom_style_navigator == 'six'){
    $main_class .= ' tm_left_menu_page';
}
?>
<body <?php body_class(); ?>>
<?php
...
<!-- Main holder -->
<div id="fl-main-holder" class="<?php echo esc_attr($main_class, 'liarch');?>">

<?php

switch ($custom_style_navigator) {
    case 'one':
        get_template_part('template-parts/navigation/navigator_one');
        break;
    case 'two':
        get_template_part('template-parts/navigation/navigator_two');
        break;
    case 'three':
        get_template_part('template-parts/navigation/navigator_three');
        break;
    case 'four':
        get_template_part('template-parts/navigation/navigator_four');
        break;
    case 'five':
        get_template_part('template-parts/navigation/navigator_five');
        break;
    case 'six': ?>
        <div class="layout layout--left-aside">
        <?php get_template_part('template-parts/navigation/navigator_six');
        break;
}
...
if (liarch_get_theme_mod('post_single_header_custom_style', true) == 'custom') {
    $header = liarch_get_theme_mod('post_single_header', true);
}

if(liarch_get_theme_mod('page_header_custom_style',true ) == 'custom' ) {
    $header = liarch_get_theme_mod('page_header', true);
}
...
?>
<?php if (isset($parallax) && $parallax == 'enable'){?>
